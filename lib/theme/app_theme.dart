...
/// A class that contains all theme configurations for the food waste management application.
class AppTheme {
  AppTheme._();

  // Trust-Forward Sustainability Color Palette
  ...
  static const Color successLight = Color(0xFF4CAF50); // Success state
  static const Color warningLight = Color(0xFFFF9800); // Food expiration alerts
  static const Color accentLight = Color(0xFF1976D2); // Blockchain verification
  ...
  static const Color onSurfaceLight = Color(0xFF212121); // Text primary
  ...
  static const Color secondaryVariantDark = Color(0xFFFF8F00); // Warm amber
  ...
  static const Color warningDark =
      Color(0xFFFFB74D); // Lighter warning for dark mode
  static const Color accentDark =
      Color(0xFF42A5F5); // Lighter accent for dark mode
  ...
  static const Color shadowMediumDark = Color(0x2A000000);

  // Divider colors - Space-first approach
  static const Color dividerLight =
      Color(0xFFE0E0E0); // 1px borders when necessary
  ...
  static const Color textSecondaryDark =
      Color(0xFFB0B0B0); // Supporting information
  static const Color textDisabledDark = Color(0xFF616161); // Disabled state

  /// Light theme optimized for outdoor visibility and food coordination
  static ThemeData lightTheme = ThemeData(
    ...
    // Bottom navigation optimized for role-based workflows
    ...
    // Button themes for clear call-to-action
    ...
    // Typography using Inter for mobile readability
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration for food tracking forms
  ...
  /// Dark theme optimized for low-light food coordination scenarios
  ...
  /// Custom text styles for specific use cases in food waste management
  ...
  static TextStyle quantityTextStyle({required bool isLight}) {
    return GoogleFonts.jetBrainsMono(
      fontSize: 16,
      fontWeight: FontWeight.w500,
      color: isLight ? textPrimaryLight : textPrimaryDark,
  ...
  static TextStyle blockchainIdTextStyle({required bool isLight}) {
    return GoogleFonts.jetBrainsMono(
      fontSize: 12,
      fontWeight: FontWeight.w400,
      color: isLight ? accentLight : accentDark,
      letterSpacing: 0.4,
      height: 1.33,
    );
  }

  /// Status indicator colors for food tracking
